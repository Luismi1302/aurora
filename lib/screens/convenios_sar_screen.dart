...
import '../services/convenios_sar_service.dart';
import '../services/pdf_service.dart';

class ConveniosSarScreen extends StatefulWidget {
  const ConveniosSarScreen({super.key});
...
class _ConveniosSarScreenState extends State<ConveniosSarScreen> {
  final _service = ConveniosSarService();
  ...
  Future<void> _downloadPdf() async {
    ...
    await _pdfService.generateAndOpenPdf(
      title: 'Convenios SAR${selectedRegion != null ? ' - $selectedRegion' : ''}',
      data: dataForPdf,
      columns: ['REGIÓN', 'PROVINCIA', 'DISTRITO', 'SAR', 'CONTRAPARTE', 'ESTADO'],
    );
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  initialValue: item['SAR']?.toString() ?? '',
                  ...
                  onChanged: (value) => item['SAR'] = value,
                ),
                TextFormField(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [                                const Icon(Icons.filter_list),
                                  ...
                                  Text(
                                    selectedRegion != null 
                                      ...
                                      : '${data.length} resultados totales'
                                  ),
